    ...
    return (
		<div className="sidebar">
			<div className="sidebar__profile-container">
				<img className="sidebar__profile-pic" src={brian}></img>
			...
			<div className="nav-buttons">
				...
				<div className="nav-buttons_button">
					<a href="https://www.linkedin.com/in/brian-w-glaser/" target="_blank">
						<i className="fab fa-linkedin nav-buttons__icon" target="_blank"></i>
						<p className="nav-buttons__link-text" target="_blank">LinkedIn</p>
					</a>
				</div>
				<div className="nav-buttons_button">
					<a href="#contact">
